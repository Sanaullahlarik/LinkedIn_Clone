...
import SideProfile3 from "../Assets/side-profile3.jpeg";
        ...
        <Box className="row">
                ...
                <CardContent>
                  ...
                  <Box className="border-bottom pb-3 mb-3">
                    ...
                    <Box className="d-flex align-items-center">
                      ...
                      />
                      <Typography variant="body2" className="text-muted mt-5">
                    ...
                    <Box className="d-flex align-items-center justify-content-between mt-2 text-muted small">
                      ...
                      <Box className="d-flex">
                        ...
                        <Typography variant="body2">189 reposts</Typography>
                      </Box>
                    </Box>
                  </Box>
                  ...
                  <Box className="border-bottom pb-3 mb-3">
                    ...
                    <Box className="d-flex align-items-center">
                      ...
                      <Typography variant="body2" className="text-muted">
                        Hey connections, I'm thrilled to share this quick
                        project I created - a QR Code Generator using HTML, CSS,
                        and JavaScript!
                      </Typography>
                    </Box>
                    <Box className="d-flex align-items-center justify-content-between mt-2 text-muted small">
                      ...
                      <Box className="d-flex">
                        ...
                        <Typography variant="body2">1 repost</Typography>
                      </Box>
                    </Box>
                  </Box>
                  ...
                  <Box className="d-flex mb-4">
                    <Box>
                      ...
                      <Box className="d-flex align-items-center mt-2">
                        ...
                        />
                        <Typography className="rounded-pill">
                          Capstone Project 3
                        </Typography>
                      </Box>
                    </Box>
                  ...
                  <Box className="d-flex mb-4">
                    <Box>
                      ...
                      <Typography variant="body2" className="mt-1">
                        ...
                        based on a Figma design, utilizing HTML5, CSS3, and
                        Bootstrap 5. Incorporated hover effects, shadowing,
                        positioning, and gradient colors.
                      </Typography>
                      <Typography
                        variant="caption"
                      ...
                      <Typography className="mt-2 rounded-pill border p-1">
                        HTML5, CSS +1 Skill
                      </Typography>
                    </Box>
                  </Box>
          ...
          <Box className="col-lg-4 col-md-12">
            ...
            <Box className="p-2 d-flex rounded-3 flex-column gap-2 bg-white mt-4 border">
              ...
              <Box className="d-flex align-items-center mb-2">
                ...
                <Box ml={2}>
                  ...
                  <Typography variant="body2">
                    ...
                    Video Editing || Empowering Entrepreneurs with Growth
                    Strategies || Climate Activist || Social Media Designer
                  </Typography>
                  <Button
                    className="rounded-pill mt-2 text-dark border-dark"
                    variant="outlined"
              ...
              <Divider className="my-2 w-100" />
              <Box className="d-flex align-items-center mb-2">
                <Avatar src={SideProfile3} sx={{ width: 60, height: 60 }} />
                <Box ml={2}>
                  <Typography variant="subtitle1" fontWeight="bold">
                    Saurabh Mahajan
                  </Typography>
                  <Typography variant="body2">
                    Python | FastApi | Django | PostgreSQL | JavaScript |
                    ReactJs | TypeScript | Redux RTK Query | GitHub
                  </Typography>
                  <Button
                    className="rounded-pill mt-2 text-dark border-dark"
                    variant="outlined"
